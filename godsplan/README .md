...
AI-assisted, personalized recommendation platform for food, places, and colleges — built with Django 5, Django REST Framework, PostgreSQL, and designed to deploy cleanly on Google Cloud (Cloud Run + Cloud SQL + Cloud Storage).

---

> Example API: `http://127.0.0.1:8000/api/catalog/places/?format=api`
